/*
  ...
  1. Changes
     - Fix RLS policies for prezzi_materiali, leasing_strumentali, and costi_utenze tables
...
DROP POLICY IF EXISTS "Authenticated users can read prezzi_materiali" ON public.prezzi_materiali;
