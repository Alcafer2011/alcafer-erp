/*
  ...
  3. Performance
    ...
    - Audit trail se disponibile

  4. Dati di esempio
    - 6 fornitori di test per iniziare

  5. Vista con statistiche
    - Collegamento con materiali_metallici (che ha campo fornitore)
    - Statistiche ordini e importi
*/
...
-- Vista per fornitori con statistiche (solo materiali_metallici che ha campo fornitore)
