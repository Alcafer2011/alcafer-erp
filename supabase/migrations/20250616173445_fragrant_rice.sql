/*
  # Fix Acconti Implementation

  1. New Functions
    - `update_acconto_importo()` - Calculates acconto_importo based on percentage
  
  2. Triggers
    - Add trigger for automatic acconto_importo calculation
  
  3. Indexes
    - Add index for accordo_gabifer
    - Add index for acconto_modalita
  
  4. Constraints
    - Ensure check constraints for acconto_modalita and accordo_gabifer
  
  5. Data Updates
    - Update existing records to calculate acconto_importo
  
  6. Views
    - Update lavori_with_preventivo view
*/
