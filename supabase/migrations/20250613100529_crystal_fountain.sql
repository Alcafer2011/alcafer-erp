/*
  ...
  1. New Tables
    ...
    - `preventivi` - Quotes with auto-generated numbers
    - `lavori` - Jobs with auto-generated numbers and advance calculations
    ...
    - `prezzi_materiali` - Material prices tracking
  ...
  2. Security
    ...
    - User-specific policies for user profiles

  3. Features
    - Auto-generated quote and job numbers
    - Automatic advance payment calculations
    - Performance indexes
