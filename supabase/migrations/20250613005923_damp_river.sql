/*
  ...
  1. New Tables
    ...
    - `preventivi` - Quote management with company assignment
    - `lavori` - Job management with detailed tracking
    - `materiali_metallici` - Metal materials used in jobs
    - `materiali_vari` - Various materials and consumables
    - `leasing_strumentali` - Equipment leasing costs
    - `costi_utenze` - Utility costs management
    - `prezzi_materiali` - Material price tracking
    - `manovalanza` - Labor cost management
