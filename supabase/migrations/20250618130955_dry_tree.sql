/*
  # Fix RLS Policies and Add Posa in Opera Table
  ...
  1. New Tables
    - `posa_in_opera`
      ...
      - `importo_totale` (numeric, computed)
      - `note` (text)
      - `created_at` (timestamp)
  2. Security
    - Reset and recreate policies for lavori table
    - Add policies for posa_in_opera table
