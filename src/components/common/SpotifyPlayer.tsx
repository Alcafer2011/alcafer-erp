...
import { Music, ExternalLink, RefreshCw, Play, Pause, SkipForward, SkipBack, Volume2, VolumeX, Disc, Headphones, Heart, Clock, ListMusic, Shuffle, Repeat, Share2 } from 'lucide-react';
      ...
      {!isConnected ? (
        <div className="text-center py-8">
          ...
          <button
            ...
            disabled={isLoading}
            className="bg-green-500 hover:bg-green-600 text-white py-3 px-8 rounded-full font-medium transition-colors flex items-center gap-2 mx-auto shadow-lg"
          >
            {isLoading ? (
              <>
          ...
          <div className="mt-6 flex justify-center">
            <div className="bg-white/10 rounded-lg p-3 max-w-md">
              <p className="text-xs text-white/70">
                Connettendo il tuo account Spotify potrai accedere a milioni di brani, playlist personalizzate e molto altro ancora.
              </p>
            </div>
          </div>
        </div>
