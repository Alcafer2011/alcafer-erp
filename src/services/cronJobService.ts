...
export class CronJobService {
  ...
  private constructor() {
    this.apiKey = import.meta.env.VITE_CRON_JOB_API_KEY;
  }
  ...
  async setupCronJobs(): Promise<void> {
    try {
      ...
      await this.createCronJob({
        ...
        url: `${import.meta.env.VITE_APP_URL}/api/cron/update-prices`,
      ...
      await this.createCronJob({
        ...
        url: `${import.meta.env.VITE_APP_URL}/api/cron/check-deadlines`,
      ...
      await this.createCronJob({
        ...
        url: `${import.meta.env.VITE_APP_URL}/api/cron/backup`,
